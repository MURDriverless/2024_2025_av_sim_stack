...
1. :doc:`The image-based pipeline (camera-based)<perc_image>`
2. :doc:`The LiDAR-based pipeline<perc_lidar>`

The reasoning for these two pipelines is due to redundancy and safety. Sure you can run one of the pipelines, but should one fail, your autonomous vehicle is now running blind. Ofcourse the emergency braking system should kick in, but having redundancy is essential in the robustness and safety of the system.

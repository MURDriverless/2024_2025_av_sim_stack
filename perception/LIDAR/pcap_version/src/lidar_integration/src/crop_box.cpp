...
public:
    CropBoxFilterNode() : Node("crop_box_node") {
...
private:
    ...
    void pointcloud_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
        // 반드시 "os1" frame만 사용! 변환 불필요
        if (msg->header.frame_id != "os1") {
        ...
        crop.setMin(Eigen::Vector4f(4.0, -6.0, -1.6, 1.0));
        ...
        output.header.frame_id = "os1";  // **반드시 os1!**
        pub_->publish(output);

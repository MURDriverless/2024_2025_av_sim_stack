...
input_csv = "/root/ros2_ws/src/csv_to_pointcloud_node/data/straight.csv"
output_csv = "/root/ros2_ws/src/csv_to_pointcloud_node/data/straight_filtered.csv"

#input_csv = "/root/ros2_ws/src/csv_to_pointcloud_node/data/curve.csv"
#output_csv = "/root/ros2_ws/src/csv_to_pointcloud_node/data/curve_filtered.csv"
...
range_index = header.index("Range (mm)")
